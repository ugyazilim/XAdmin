...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="mb-1" style="font-weight: 700; color: #1f2937;">Yeni Kategori Oluştur</h2>
        <p class="text-muted mb-0">Proje kategorilerini yönetmek için yeni bir kategori ekleyin</p>
    </div>
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="bi bi-folder-plus me-2"></i>Kategori Bilgileri</h5>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="mb-4">
                        ...
                        <div class="input-group-icon">
                            ...
                            <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" 
                                   ...
                                   placeholder="Örn: Konut Projeleri, Ticari Projeler, Endüstriyel Projeler">
                        </div>
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group-icon">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Bu kategori hakkında kısa bir açıklama">{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-muted">Düşük sayılar önce görünür</small>
                        @error('sort_order')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
