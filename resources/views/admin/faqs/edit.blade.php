...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">SSS Düzenle</h1>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('category') is-invalid @enderror" id="category" name="category">
                                ...
                                <option value="hizmetler" {{ old('category', $faq->category) == 'hizmetler' ? 'selected' : '' }}>Hizmetler</option>
                                <option value="ürünler" {{ old('category', $faq->category) == 'ürünler' ? 'selected' : '' }}>Ürünler</option>
                                <option value="genel" {{ old('category', $faq->category) == 'genel' ? 'selected' : '' }}>Genel</option>
                            </select>
                            @error('category')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
